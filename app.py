    ...
    def display_inflation_data(self):
        ...
        if selected_country:
            ...
            st.write("*Polynomial Regression model*\n"
                     ...
                     "there might not be much variation between this model and the Linear Regression model. "
            ...
            st.write("*ARIMA (AutoRegressive Integrated Moving Average)*\n"
                     ...
                     "𝑑 is the number of times the raw observations are "
                     ...
                     "although for most inflation data, we cannot call it stationary.\n"
